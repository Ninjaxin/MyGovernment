...
public class Locator {
    ...
    public Locator(MainActivity activity) {
        ...
        if(owner.networkCheck()) {
            ...
            owner.addressText.setText("No Data For Location");
            owner.showDialogAlert("No Network Connection", "Data Cannot br Accessed/loaded without an internet connection");
    ...
    public void setUpLocationManager() {
        ...
        locationListener = new LocationListener() {
            public void onLocationChanged(Location location) {
                ...
                owner.displayAddress(location.getLatitude(), location.getLongitude());
            }
...
//                LocationManager.GPS_PROVIDER, 1000, 0, locationListener);
    ...
    public void determineLocation() {
        ...
        if (locationManager != null) {
            ...
            if (loc != null) {
                owner.displayAddress(loc.getLatitude(), loc.getLongitude());
